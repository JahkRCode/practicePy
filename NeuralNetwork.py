...
## Description: Understanding Neural Networks with Numpy
...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        delta_weights_i_h = delta_weights_i_h + (hidden_error_term * X.T[:, None])
        
        # Weight step (hidden to output)
        delta_weights_h_o = delta_weights_h_o + (output_error_term * hidden_outputs).T[:, None]
